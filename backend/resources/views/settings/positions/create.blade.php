...
<div>
    ...
    <form method="POST" action="{{ route('settings.positions.store') }}" novalidate>
        @csrf
        <div class="card p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="2" maxlength="1000" class="form-input resize-y">{{ old('description') }}</textarea>
                </div>
                <div class="md:col-span-2">
