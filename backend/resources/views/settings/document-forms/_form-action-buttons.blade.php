...
<div class="flex items-center px-2">
    <button type="button" @click="openPreview()"
            class="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-100">
...
<div class="flex items-center px-2">
    <a href="{{ route('settings.document-forms.index') }}"
       class="inline-flex items-center rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-100">{{ __('common.cancel') }}</a>
</div>
...
<a href="{{ route('settings.document-forms.index') }}"
   class="inline-flex items-center gap-1 self-stretch border-t-[3px] border-t-white dark:border-t-gray-800 px-3 text-sm font-medium text-gray-500 transition-colors hover:border-t-blue-400 hover:bg-gray-50 hover:text-gray-800 dark:text-gray-400 dark:hover:border-t-blue-400 dark:hover:bg-gray-800 dark:hover:text-gray-100">
