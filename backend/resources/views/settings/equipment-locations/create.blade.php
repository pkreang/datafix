...
<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-slate-900 dark:text-slate-100">{{ __('common.add_equipment_location') }}</h2>
    ...
    <form method="POST" action="{{ route('settings.equipment-locations.store') }}" novalidate>
        @csrf
