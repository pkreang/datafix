...
<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">{{ __('common.add_equipment_location') }}</h2>
    ...
    <form method="POST" action="{{ route('settings.equipment-locations.store') }}">
        @csrf
        <div class="bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                ...
                <div>
                    ...
                    <input name="building" value="{{ old('building') }}" maxlength="255"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="2" maxlength="1000"
                              class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-y bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">{{ old('description') }}</textarea>
                </div>
