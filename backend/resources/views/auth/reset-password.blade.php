        ...
        <form method="POST" action="{{ route('password.update') }}" class="space-y-5" novalidate>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button"
                            class="js-auth-password-toggle absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 focus:outline-none"
                            aria-pressed="false"
